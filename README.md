...
- **No dock** — Ubuntu Dock disabled. A lime Ubuntu circle in the **top bar** opens the app grid (`x47-show-apps@x47`); the panel is taller (~58px) so the circle and status icons stay in proportion; **Super** still opens Activities; **Super+1…9** launches favorites.
