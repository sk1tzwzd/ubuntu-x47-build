...
- **X47 wallpapers** — ASCII knuckle-duster on the same circuit pattern, one colourway per desktop-cube workspace: **teal on dark, pink on white, dark red on baby blue, white on green** (switched by `x47-ws-walls@x47`). Reproducible with `scripts/make-wallpaper.py --all`.
